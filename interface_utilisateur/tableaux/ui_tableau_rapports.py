...
class TableauRapportsUI(QWidget):
    """
    Interface générique pour afficher les rapports avec un tableau adaptable.
    """
    def __init__(self, titre, colonnes, donnees, main_window, retour_widget):
        ...
        self.retour_widget = retour_widget  # Widget vers lequel retourner
        self.initUI()
    ...
    def initUI(self):
        ...
        self.search_input.setPlaceholderText("🔍 Rechercher dans les rapports...")
    ...
    def filtrer_tableau(self):
        ...
        for ligne in self.donnees:
            # Vérifie si le terme apparaît dans n'importe quelle colonne de la ligne
            if any(terme in str(valeur).lower() for valeur in ligne):
                donnees_filtrees.append(ligne)

        self.charger_donnees(donnees_filtrees)
