...
class TableauReservationsUI(QWidget):
    """
    Interface générique pour afficher les réservations avec un champ de recherche.
    """
    ...
    def initUI(self):
        ...
        self.search_input.setPlaceholderText("🔍 Rechercher par Nom du Client ou Date...")
    ...
    def retourner(self):
        """Retourne à l'écran de gestion des réservations."""
